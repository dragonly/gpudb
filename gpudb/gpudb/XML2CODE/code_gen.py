...
def generate_code(tree):
    ...
    print >>fo, "\tif(setPath == 1) {"
    print >>fo, "\t\tint ret = chdir(path);"
    print >>fo, "\t\tif (ret == -1) {"
    print >>fo, "\t\t\tchar *msg = strerror(errno);"
    print >>fo, "\t\t\tprintf(\"chdir to datadir failed: %s\\n\", msg);"
    print >>fo, "\t\t\texit(ret);\n"
    print >>fo, "\t\t}"
    print >>fo, "\t}\n"
    ...
    if len(aggNode) >0 :
        ...
        for i in range(0,selectLen):
            ...
            if isinstance(exp, ystree.YFuncExp):
                ...
                print >>fo, "\tgbNode->gbExp[" + str(i) + "].exp.exp = 0;"
